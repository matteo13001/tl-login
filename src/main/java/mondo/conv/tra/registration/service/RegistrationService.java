...
import mondo.conv.tra.registration.email.service.EmailSender;
...
public class RegistrationService {
	...
	public String register(RegistrationRequest registrationRequest) {
		...
		AppUser appUser = new AppUser(registrationRequest.getUsername(), registrationRequest.getPassword(), Role.ADMIN,
				registrationRequest.getEmail(), false);

		String token = appUserService.signUpUser(appUser, registrationRequest.getPassword());
